...
public class MyFriendFragment extends Fragment {
    ...
    public void getImagePub() {
        usersDb = FirebaseDatabase.getInstance().getReference().child("Ads").child("myFriend").child("image1");
        ...
        usersDb = FirebaseDatabase.getInstance().getReference().child("Ads").child("myFriend").child("image2");
        usersDb.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
        ...
        usersDb = FirebaseDatabase.getInstance().getReference().child("Ads").child("myFriend").child("image3");
        usersDb.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
        ...
        usersDb = FirebaseDatabase.getInstance().getReference().child("Ads").child("myFriend").child("image4");
        usersDb.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
        ...
        usersDb = FirebaseDatabase.getInstance().getReference().child("Ads").child("myFriend").child("image5");
        usersDb.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
        ...
        usersDb = FirebaseDatabase.getInstance().getReference().child("Ads").child("myFriend").child("image6");
        usersDb.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
